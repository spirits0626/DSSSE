...
public class BloomFilter<E> implements Serializable {
    ...
    public static void writeLshToFile(String path, BloomFilter filter) throws IOException {
    ...
    public static BloomFilter readLshFromFile(String file)
    ...
    public static void main(String[] args) throws IOException {
        /**
         BloomFilter bloomFilter = new BloomFilter(2, 250, 15);
         bloomFilter.add("jo");
         bloomFilter.add("oh");
         bloomFilter.add("hh");
         bloomFilter.add("hn");
         ...
         bloomFilter.add("oh");
         bloomFilter.add("hn");
         set = bloomFilter.getBitSet();
         System.out.println(set.toString());
         */

        BloomFilter bloomFilter = new BloomFilter(Global.c, Global.n, Global.k);
        writeLshToFile(Global.BloomFilterPath, bloomFilter);
    }
}
